...
public class SwaggerConfig {
	...
	public OpenAPI openAPI()
	{
		...
		info.setContact(new Contact().email("sheetalshakshi143@gmail.com").name("Sheetal Kumar").url("http://theenotes.com/contact"));
		info.setLicense(new License().name("Enotes 1.0").url("http://theenotes.com"));
